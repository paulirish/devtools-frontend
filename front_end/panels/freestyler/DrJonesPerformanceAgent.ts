 ...
 */
export class DrJonesPerformanceAgent extends AiAgent<Trace.Helpers.TreeHelpers.EventNodeForAI> {
  ...
  async *
      handleContextDetails(selectedStackTrace: Trace.Helpers.TreeHelpers.EventNodeForAI|null):
  ...
  override async enhanceQuery(query: string, selectedStackTrace: Trace.Helpers.TreeHelpers.EventNodeForAI|null):
      Promise<string> {
...
function createContextDetailsForDrJonesPerformanceAgent(selectedStackTrace: Trace.Helpers.TreeHelpers.EventNodeForAI|
