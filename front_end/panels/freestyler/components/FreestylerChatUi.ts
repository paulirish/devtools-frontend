...
export interface Props {
  ...
  selectedStackTrace: Trace.Helpers.TreeHelpers.EventNodeForAI|null;
  isLoading: boolean;
...
export class FreestylerChatUi extends HTMLElement {
  ...
  #renderSelectedTask = (): LitHtml.TemplateResult => {
    ...
    const selectedNode =
        Trace.Helpers.TreeHelpers.EventNodeForAI.getSelectedNodeWithinTree(this.#props.selectedStackTrace);
