...
{{
    ...
    subItems:
(!Array.<!InspectorFrontendHostAPI.ContextMenuDescriptor>|undefined)
}} */
...
InspectorFrontendHostAPI.Events = {
  ...
  DevicesPortForwardingStatusChanged:
      Symbol('devicesPortForwardingStatusChanged'),
  ...
  [
    InspectorFrontendHostAPI.Events.AddExtensions, 'addExtensions',
    ['extensions']
  ],
  ...
  [
    InspectorFrontendHostAPI.Events.DeviceCountUpdated, 'deviceCountUpdated',
    ['count']
  ],
  [
  ...
  [
    InspectorFrontendHostAPI.Events.DevicesUpdated, 'devicesUpdated',
    ['devices']
  ],
  [
    InspectorFrontendHostAPI.Events.DispatchMessage, 'dispatchMessage',
    ['messageObject']
  ],
  [
  ...
  [
    InspectorFrontendHostAPI.Events.EvaluateForTestInFrontend,
    'evaluateForTestInFrontend', ['callId', 'script']
  ],
  [
    InspectorFrontendHostAPI.Events.FileSystemsLoaded, 'fileSystemsLoaded',
    ['fileSystems']
  ],
  [
    InspectorFrontendHostAPI.Events.FileSystemRemoved, 'fileSystemRemoved',
    ['fileSystemPath']
  ],
  [
  ...
  [
    InspectorFrontendHostAPI.Events.IndexingDone, 'indexingDone',
  ...
  [
    InspectorFrontendHostAPI.Events.ReloadInspectedPage, 'reloadInspectedPage',
    ['hard']
  ],
  [
  ...
  [
    InspectorFrontendHostAPI.Events.SetInspectedTabId, 'setInspectedTabId',
    ['tabId']
  ],
  [
...
InspectorFrontendHostAPI.prototype = {
  ...
  /**
   * Requests inspected page to be placed atop of the inspector frontend with
   * specified bounds.
   ...
   * @param {function(!InspectorFrontendHostAPI.LoadNetworkResourceResult)}
   * callback
   */
