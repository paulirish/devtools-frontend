 ...
 */
WebInspector.LayerPaintProfilerView =
    function(showImageForLayerCallback) {
  ...
  this._paintProfilerView =
      new WebInspector.PaintProfilerView(this._showImage.bind(this));
  ...
  profileLayer: function(layer) {
    ...
    /** @type {!WebInspector.AgentLayer} */ (layer).requestSnapshot(
        onSnapshotDone.bind(this));
    ...
    function onCommandLogDone(snapshot, log) {
      ...
      this._paintProfilerView.setSnapshotAndLog(
          snapshot || null, log || [], null);
    }
  },
