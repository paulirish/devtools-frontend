...
export function clearCacheForTrace(parsedTrace: Handlers.Types.HandlerData): void {
 ...
 * them together.
 */
export function get(event: Types.Events.Event, parsedTrace: Handlers.Types.HandlerData): Protocol.Runtime.StackTrace|
    null {
...
function getForProfileCall(
    event: Types.Events.SyntheticProfileCall, parsedTrace: Handlers.Types.HandlerData): Protocol.Runtime.StackTrace {
 ...
 * trace.
 */
function getForExtensionEntry(event: Types.Extensions.SyntheticExtensionEntry, parsedTrace: Handlers.Types.HandlerData):
...
function getForUserTiming(
    ...
    parsedTrace: Handlers.Types.HandlerData): Protocol.Runtime.StackTrace|null {
