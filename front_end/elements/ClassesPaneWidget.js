...
WebInspector.ClassesPaneWidget =
  ...
  WebInspector.targetManager.addModelListener(
      WebInspector.DOMModel, WebInspector.DOMModel.Events.DOMMutated,
      this._onDOMMutated, this);
  /** @type {!Set<!WebInspector.DOMNode>} */
  this._mutatingNodes = new Set();
  WebInspector.context.addFlavorChangeListener(
      WebInspector.DOMNode, this._update, this);
}
...
WebInspector.ClassesPaneWidget.prototype =
      ...
      _update: function() {
        ...
        for (var i = 0; i < keys.length; ++i) {
          ...
          label.checkboxElement.addEventListener(
              'click', this._onClick.bind(this, className), false);
     ...
     */
      ...
      _installNodeClasses: function(node) {
        ...
        node.setAttributeValue(
            'class', newClasses.join(' '), onClassNameUpdated.bind(this));
     ...
     */
    WebInspector.ClassesPaneWidget.ButtonProvider =
        function() {
      this._button = new WebInspector.ToolbarToggle(
          WebInspector.UIString('Element Classes'), '');
