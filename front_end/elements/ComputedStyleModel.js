...
WebInspector.ComputedStyleModel =
    ...
    if (this._cssModel && domModel && resourceTreeModel) {
      this._targetEvents = [
        this._cssModel.addEventListener(
            ...
            this._onComputedStyleChanged, this),
        this._cssModel.addEventListener(
        ...
        this._cssModel.addEventListener(
            ...
            this._onComputedStyleChanged, this),
        this._cssModel.addEventListener(
            WebInspector.CSSModel.Events.FontsUpdated,
            this._onComputedStyleChanged, this),
        this._cssModel.addEventListener(
        ...
        this._cssModel.addEventListener(
            ...
            this._onComputedStyleChanged, this),
        this._cssModel.addEventListener(
            WebInspector.CSSModel.Events.ModelWasEnabled,
            this._onComputedStyleChanged, this),
        domModel.addEventListener(
            WebInspector.DOMModel.Events.DOMMutated, this._onDOMModelChanged,
            this),
        resourceTreeModel.addEventListener(
            WebInspector.ResourceTreeModel.Events.FrameResized,
            this._onFrameResized, this),
      ];
    }
  },
  ...
  */
  _onComputedStyleChanged: function(event) {
    ...
    this.dispatchEventToListeners(
        WebInspector.ComputedStyleModel.Events.ComputedStyleChanged,
  ...
  */
  _onDOMModelChanged: function(event) {
    // Any attribute removal or modification can affect the styles of "related"
    // nodes.
  ...
  fetchComputedStyle: function() {
    ...
    if (!this._computedStylePromise)
      this._computedStylePromise =
          cssModel.computedStylePromise(elementNode.id)
    ...
    function verifyOutdated(elementNode, style) {
      return elementNode === this._elementNode() && style ?
          new WebInspector.ComputedStyleModel.ComputedStyle(
              elementNode, style) :
          /** @type {?WebInspector.ComputedStyleModel.ComputedStyle} */ (null);
    }
  },
