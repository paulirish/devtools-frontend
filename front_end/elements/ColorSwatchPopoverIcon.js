 ...
 */
WebInspector.BezierPopoverIcon =
    function(treeElement, swatchPopoverHelper, swatch) {
  ...
  this._swatch.iconElement().addEventListener(
      'click', this._iconClick.bind(this), false);
  ...
  _iconClick: function(event) {
    ...
    var cubicBezier =
        WebInspector.Geometry.CubicBezier.parse(this._swatch.bezierText());
    if (!cubicBezier)
    ...
    this._swatchPopoverHelper.show(
        this._bezierEditor, this._swatch.iconElement(),
        this._onPopoverHidden.bind(this));
    this._scrollerElement =
        this._swatch.enclosingNodeOrSelfWithClass('style-panes-wrapper');
    if (this._scrollerElement)
      this._scrollerElement.addEventListener(
          'scroll', this._boundOnScroll, false);
  ...
  _bezierChanged: function(event) {
    ...
    this._treeElement.applyStyleText(
        this._treeElement.renderedPropertyText(), false);
  },
  ...
  _onPopoverHidden: function(commitEdit) {
    if (this._scrollerElement)
      this._scrollerElement.removeEventListener(
          'scroll', this._boundOnScroll, false);
    ...
    var propertyText = commitEdit ? this._treeElement.renderedPropertyText() :
    ...
    delete this._originalPropertyText;
                     ...
                     /**
                      * @constructor
                      * @param {!WebInspector.StylePropertyTreeElement}
                      * treeElement
                      * @param {!WebInspector.SwatchPopoverHelper}
                      * swatchPopoverHelper
        ...
        function(treeElement, swatchPopoverHelper, swatch) {
  this._treeElement = treeElement;
  this._treeElement[WebInspector.ColorSwatchPopoverIcon._treeElementSymbol] =
      this;
  this._swatchPopoverHelper = swatchPopoverHelper;
  this._swatch = swatch;

  var shiftClickMessage =
      WebInspector.UIString('Shift + Click to change color format.');
  this._swatch.iconElement().title =
      WebInspector.UIString('Open color picker. %s', shiftClickMessage);
  this._swatch.iconElement().addEventListener(
      'click', this._iconClick.bind(this));
 ...
 */
WebInspector.ColorSwatchPopoverIcon.forTreeElement =
    function(treeElement) {
  return treeElement[WebInspector.ColorSwatchPopoverIcon._treeElementSymbol] ||
      null;
}
  ...
  showPopover: function() {
    ...
    this._swatchPopoverHelper.show(
        this._spectrum, this._swatch.iconElement(),
        this._onPopoverHidden.bind(this));
    this._scrollerElement =
        this._swatch.enclosingNodeOrSelfWithClass('style-panes-wrapper');
    if (this._scrollerElement)
  ...
  _onPopoverHidden: function(commitEdit) {
    ...
    delete this._originalPropertyText;
                      ...
                      */
                     WebInspector.ShadowSwatchPopoverHelper =
        function(treeElement, swatchPopoverHelper, shadowSwatch) {
  this._treeElement = treeElement;
  this._treeElement[WebInspector.ShadowSwatchPopoverHelper._treeElementSymbol] =
      this;
  this._swatchPopoverHelper = swatchPopoverHelper;
  ...
  this._iconElement.addEventListener(
      'click', this._iconClick.bind(this), false);
 ...
 */
WebInspector.ShadowSwatchPopoverHelper.forTreeElement =
    function(treeElement) {
  return treeElement[WebInspector.ShadowSwatchPopoverHelper
                         ._treeElementSymbol] ||
      null;
}
  ...
  showPopover: function() {
    ...
    this._cssShadowEditor.addEventListener(
        WebInspector.CSSShadowEditor.Events.ShadowChanged,
        this._boundShadowChanged);
    this._swatchPopoverHelper.show(
        this._cssShadowEditor, this._iconElement,
        this._onPopoverHidden.bind(this));
    this._scrollerElement =
        this._iconElement.enclosingNodeOrSelfWithClass('style-panes-wrapper');
    if (this._scrollerElement)
      this._scrollerElement.addEventListener(
          'scroll', this._boundOnScroll, false);
  ...
  _shadowChanged: function(event) {
    this._shadowSwatch.setCSSShadow(
        /** @type {!WebInspector.CSSShadowModel} */ (event.data));
    this._treeElement.applyStyleText(
        this._treeElement.renderedPropertyText(), false);
  },
