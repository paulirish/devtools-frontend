 ...
 */
WebInspector.TargetsComboBoxController =
    function(selectElement, elementToHide) {
  elementToHide.classList.add('hidden');
  selectElement.addEventListener(
      'change', this._onComboBoxSelectionChange.bind(this), false);
  ...
  WebInspector.context.addFlavorChangeListener(
      WebInspector.Target, this._targetChangedExternally, this);
  WebInspector.targetManager.observeTargets(
      this, WebInspector.Target.Capability.JS);
}
  ...
  _onComboBoxSelectionChange: function() {
    ...
    WebInspector.context.setFlavor(
        WebInspector.Target, selectedOption.__target);
  },
