...
WebInspector.ProfileView =
  ...
  this._viewType = WebInspector.settings.createSetting(
      'profileView', WebInspector.ProfileView.ViewTypes.Heavy);
  ...
  var options = new Map(viewTypes.map(
      type =>
          [type, this.viewSelectComboBox.createOption(
                     optionNames.get(type), '', type)]));
 ...
 */
  ...
  syncToolbarItems: function() {
    return [
      this.viewSelectComboBox, this.focusButton, this.excludeButton,
      this.resetButton
    ];
  },
  ...
  _getBottomUpProfileDataGridTree: function() {
    if (!this._bottomUpProfileDataGridTree)
      this._bottomUpProfileDataGridTree =
          new WebInspector.BottomUpProfileDataGridTree(
              this._nodeFormatter, this._searchableView, this.profile.root,
              this.adjustedTotal);
  ...
  _getTopDownProfileDataGridTree: function() {
    if (!this._topDownProfileDataGridTree)
      this._topDownProfileDataGridTree =
          new WebInspector.TopDownProfileDataGridTree(
              this._nodeFormatter, this._searchableView, this.profile.root,
              this.adjustedTotal);
  ...
  performSearch: function(searchConfig, shouldJump, jumpBackwards) {
    this._searchableElement.performSearch(
  ...
  _ensureFlameChartCreated: function() {
    ...
    this._flameChart = new WebInspector.CPUProfileFlameChart(
        this._searchableView, this._dataProvider);
  ...
  _onEntrySelected: function(event) {
    ...
    var location = /** @type {!WebInspector.DebuggerModel.Location} */ (
        debuggerModel.createRawLocation(
            script, node.lineNumber, node.columnNumber));
  ...
  _changeView: function() {
    ...
    var isFlame =
        this._viewType.get() === WebInspector.ProfileView.ViewTypes.Flame;
  ...
  _sortProfile: function() {
    ...
    var sortProperty = sortColumnIdentifier === 'function' ?
        'functionName' :
  ...
  __proto__: WebInspector.SimpleView.prototype
                          ...
                          * @param {string=} title
                          */
                         WebInspector.WritableProfileHeader =
  ...
  createSidebarTreeElement: function(panel) {
    return new WebInspector.ProfileSidebarTreeElement(
        panel, this, 'profile-sidebar-tree-item');
  },
      ...
      function didRead(data) {
        if (data)
          fileOutputStream.write(
              data, fileOutputStream.close.bind(fileOutputStream));
        else
