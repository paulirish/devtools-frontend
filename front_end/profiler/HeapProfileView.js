...
WebInspector.HeapProfileView =
  ...
  WebInspector.ProfileView.call(
      this, new WebInspector.HeapProfileView.NodeFormatter(this), views);
}
     ...
     */
          createFlameChartDataProvider: function() {
            return new WebInspector.HeapFlameChartDataProvider(
         ...
         */
        WebInspector.SamplingHeapProfileType =
            function() {
...
WebInspector.SamplingHeapProfileType
  ...
  __proto__: WebInspector.ProfileType.prototype
                  ...
                  * @param {string=} title
                  */
                 WebInspector.SamplingHeapProfileHeader =
    function(target, type, title) {
  WebInspector.WritableProfileHeader.call(
      this, target, type,
      title || WebInspector.UIString('Profile %d', type.nextProfileUid()));
}
  ...
  __proto__: WebInspector.WritableProfileHeader.prototype
                      ...
                      */
                     WebInspector.SamplingHeapProfileNode =
        function(node) {
  ...
  __proto__: WebInspector.ProfileNode.prototype
                          ...
                          * @param {!HeapProfilerAgent.SamplingHeapProfile}
                          * profile
                          */
                         WebInspector.SamplingHeapProfileModel =
            function(profile) {
  WebInspector.ProfileTreeModel.call(
      this, this._translateProfileTree(profile.head));
}
  ...
  _translateProfileTree: function(root) {
    ...
    while (sourceNodeStack.length) {
      ...
      parentNode.children = sourceNode.children.map(
          child => new WebInspector.SamplingHeapProfileNode(child));
  ...
  __proto__: WebInspector.ProfileTreeModel.prototype
                              ...
                              */
                             WebInspector.HeapProfileView.NodeFormatter =
  ...
  linkifyNode: function(node) {
    return this._profileView.linkifier().maybeLinkifyConsoleCallFrame(
        ...
        'profile-node-file');
                                  ...
                                  * @param {!WebInspector.ProfileTreeModel}
                                  * profile
                                  * @param {?WebInspector.Target} target
                                  */
                                 WebInspector.HeapFlameChartDataProvider =
  ...
  formatValue: function(value, precision) {
    return WebInspector.UIString(
        '%s\u2009KB', Number.withThousandsSeparator(value / 1e3));
  },
  ...
  prepareHighlightedEntryInfo: function(entryIndex) {
    ...
    pushEntryInfoRow(
        ...
        WebInspector.beautifyFunctionName(node.functionName));
    pushEntryInfoRow(
        WebInspector.UIString('Self size'), Number.bytesToString(node.self));
    pushEntryInfoRow(
        WebInspector.UIString('Total size'), Number.bytesToString(node.total));
