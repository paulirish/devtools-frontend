...
WebInspector.ListWidget =
  ...
  this.clear();
     ...
     * @interface
     */
    WebInspector.ListWidget.Delegate =
        function() {}
  ...
  appendSeparator: function() { this._lastSeparator = true; },
  ...
  removeItem: function(index) {
    ...
    var previousIsSeparator =
        previous && previous.classList.contains('list-separator');
  ...
  _startEditing: function(item, element, insertionPoint) {
    ...
    this._editor.beginEdit(
        item, index,
        element ? WebInspector.UIString('Save') : WebInspector.UIString('Add'),
  ...
  __proto__: WebInspector.VBox.prototype
                                           ...
                                           * @constructor
                                           */
                                          WebInspector.ListWidget.Editor =
            function() {
  this.element = createElementWithClass('div', 'editor-container');
  this.element.addEventListener(
      'keydown', onKeyDown.bind(null, isEscKey, this._cancelClicked.bind(this)),
      false);
  this.element.addEventListener(
      'keydown',
      onKeyDown.bind(null, isEnterKey, this._commitClicked.bind(this)), false);
  ...
  this._cancelButton = createTextButton(
      WebInspector.UIString('Cancel'), this._cancelClicked.bind(this));
  this._cancelButton.addEventListener(
      'keydown',
      onKeyDown.bind(null, isEnterKey, this._cancelClicked.bind(this)), false);
   ...
   * (!HTMLInputElement|!HTMLSelectElement)):boolean>} */
  this._validators = [];
  ...
  createInput: function(name, type, title, validator) {
    ...
    input.addEventListener(
        'input', this._validateControls.bind(this, false), false);
    input.addEventListener(
        'blur', this._validateControls.bind(this, false), false);
  ...
  createSelect: function(name, options, validator) {
    var select = /** @type {!HTMLSelectElement} */ (
        createElementWithClass('select', 'chrome-select'));
  ...
  _validateControls: function(forceValid) {
    ...
    for (var index = 0; index < this._controls.length; ++index) {
      ...
      var valid =
          this._validators[index].call(null, this._item, this._index, input);
