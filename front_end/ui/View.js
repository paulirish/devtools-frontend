 ...
 */
WebInspector.SimpleView =
    function(title, isWebComponent) {
  ...
  /**
     ...
     * @return {string}
     */
  viewId: function() { return this._title; },
  ...
  /**
     ...
     * @return {boolean}
     */
  isCloseable: function() { return false; },
  ...
  /**
     ...
     * @return {!Promise<!Array<!WebInspector.ToolbarItem>>}
     */
  toolbarItems: function() { return Promise.resolve(this.syncToolbarItems()); },

  /**
     * @return {!Array<!WebInspector.ToolbarItem>}
     */
  syncToolbarItems: function() { return this._toolbarItems; },
  ...
  /**
     ...
     */
  widget: function() {
    return /** @type {!Promise<!WebInspector.Widget>} */ (
   ...
   */
  addToolbarItem: function(item) { this._toolbarItems.push(item); },

  /**
     * @return {!Promise}
     */
  revealView: function() { return WebInspector.viewManager.revealView(this); },
  ...
  /**
     ...
     * @return {string}
     */
  viewId: function() { return this._extension.descriptor()['id']; },

  /**
     * @override
     * @return {string}
     */
  title: function() { return this._extension.title(); },
  ...
  toolbarItems: function() {
    ...
    if (actionIds) {
      var result = [] for (var id of actionIds.split(',')) {
    ...
    if (this._extension.descriptor()['hasToolbar'])
      return this.widget().then(
          widget =>
              /** @type {!WebInspector.ToolbarItem.ItemsProvider} */ (widget)
                  .toolbarItems());
  ...
  widget: function() {}
                              ...
                              */
                             WebInspector.TabbedViewLocation =
                function() {}
  ...
  enableMoreTabsButton: function() {}
                                  ...
                                  * @interface
                                  */
                                 WebInspector.ViewLocationResolver =
                    function() {}
  ...
  revealView: function(view) {
    var location = /** @type {?WebInspector.ViewManager._Location} */ (
        view[WebInspector.ViewManager._Location.symbol]);
    if (!location)
      return Promise.resolve();
    location._reveal();
  ...
  /**
     ...
     */
  view: function(viewId) { return this._views.get(viewId); },
  ...
  showView: function(viewId) {
    ...
    if (!view) {
      console.error(
          'Could not find view for id: \'' + viewId + '\' ' +
          new Error().stack);
      return Promise.resolve();
    }
  ...
  _resolveLocation: function(location) {
    if (!location)
      return /** @type {!Promise<?WebInspector.ViewManager._Location>} */ (
    ...
    return resolverExtension.instance().then(
        resolver => /** @type {?WebInspector.ViewManager._Location} */ (
            resolver.resolveLocation(location)));
  },
  ...
  createTabbedLocation: function(revealCallback, location, restoreSelection) {
    return new WebInspector.ViewManager._TabbedLocation(
        this, revealCallback, location, restoreSelection);
  },
  ...
  createStackLocation: function(revealCallback, location) {
    return new WebInspector.ViewManager._StackLocation(
        this, revealCallback, location);
  },
  ...
  _viewsForLocation: function(location) {
    ...
    return result;
                                          ...
                                          * @param
                                          * {!Array<!WebInspector.ToolbarItem>}
                                          * toolbarItems
                                          */
                                         WebInspector.ViewManager
                                             ._populateToolbar =
                            function(element, toolbarItems) {
  ...
  for (var item of toolbarItems)
    toolbar.appendToolbarItem(item);
                             ...
                             * @param {!WebInspector.View} view
                             */
                            WebInspector.ViewManager._ContainerWidget =
                                function(view) {
  ...
  this._view = view;
     ...
     */
                                      _materialize: function() {
                                        ...
                                        var promises = [];
                                        promises.push(
                                            this._view.toolbarItems().then(
                                                WebInspector.ViewManager
                                                    ._populateToolbar.bind(
                                                        WebInspector
                                                            .ViewManager,
                                                        this.element)));
                                        promises.push(this._view.widget().then(
                                            widget =>
                                    ...
                                    WebInspector.ViewManager
                                      ...
                                      this._titleElement =
                                          createElementWithClass(
                                              'div', 'expandable-view-title');
                                      this._titleElement.textContent =
                                          view.title();
                                      this._titleElement.tabIndex = 0;
                                      this._titleElement.addEventListener(
                                          'click',
...
WebInspector.ViewManager._ExpandableContainerWidget.prototype =
     ...
     */
      _materialize: function() {
        ...
        promises.push(this._view.toolbarItems().then(
            WebInspector.ViewManager._populateToolbar.bind(
                WebInspector.ViewManager, this._titleElement)));
     ...
     * @param {function()=} revealCallback
     */
    WebInspector.ViewManager._Location =
        function(manager, widget, revealCallback) {
...
WebInspector.ViewManager._Location
  ...
  _reveal: function() {
    if (this._revealCallback)
      this._revealCallback();
                  ...
                  * @param {boolean=} restoreSelection
                  */
                 WebInspector.ViewManager._TabbedLocation =
    function(manager, revealCallback, location, restoreSelection) {
  this._tabbedPane = new WebInspector.TabbedPane();
  WebInspector.ViewManager._Location.call(
      this, manager, this._tabbedPane, revealCallback);
  ...
  this._closeableTabSetting =
      WebInspector.settings.createSetting(location + '-closeableTabs', {});
  if (restoreSelection)
    this._lastSelectedTabSetting =
        WebInspector.settings.createSetting(location + '-selectedTab', '');
  ...
  /**
     ...
     * @return {!WebInspector.Widget}
     */
  widget: function() { return this._tabbedPane; },

  /**
     * @override
     * @return {!WebInspector.TabbedPane}
     */
  tabbedPane: function() { return this._tabbedPane; },
  ...
  _appendTab: function(view) {
    this._tabbedPane.appendTab(
        view.viewId(), view.title(),
        new WebInspector.ViewManager._ContainerWidget(view), undefined, false,
  ...
  _materializeWidget: function(view) {
    var widget = /** @type {!WebInspector.ViewManager._ContainerWidget} */ (
  ...
  __proto__: WebInspector.ViewManager._Location.prototype
                      ...
                      * @param {string=} location
                      */
                     WebInspector.ViewManager._StackLocation =
        function(manager, revealCallback, location) {
  this._vbox = new WebInspector.VBox();
  WebInspector.ViewManager._Location.call(
      this, manager, this._vbox, revealCallback);
  ...
  appendView: function(view, insertBefore) {
    ...
    if (!container) {
      ...
      if (insertBefore) {
        var beforeContainer =
            insertBefore[WebInspector.ViewManager._ExpandableContainerWidget
                             ._symbol];
