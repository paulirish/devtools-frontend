...
WebInspector.ResizerWidget.prototype = {
  ...
  /**
     ...
     */
  elements: function() { return this._elements.slice(); },
  ...
  addElement: function(element) {
    ...
    element.addEventListener(
        'mousedown', this._installDragOnMouseDownBound, false);
  ...
  /**
     * @return {string}
     */
  cursor: function() { return this._cursor; },
  ...
  _installDragOnMouseDown: function(event) {
    ...
    WebInspector.elementDragStart(
        /** @type {!Element} */ (event.target), this._dragStart.bind(this),
        this._drag.bind(this), this._dragEnd.bind(this), this.cursor(), event);
  },
  ...
  sendDragStart: function(x, y) {
    this.dispatchEventToListeners(
        WebInspector.ResizerWidget.Events.ResizeStart,
        {startX: x, currentX: x, startY: y, currentY: y});
  },
  ...
  _drag: function(event) {
    ...
    this.sendDragMove(
        this._startX, event.pageX, this._startY, event.pageY, event.shiftKey);
...
WebInspector.SimpleResizerWidget.prototype = {
  ...
  /**
     ...
     * @return {string}
     */
  cursor: function() { return this._isVertical ? 'ns-resize' : 'ew-resize'; },
  ...
  sendDragStart: function(x, y) {
    ...
    this.dispatchEventToListeners(
        WebInspector.ResizerWidget.Events.ResizeStart,
        {startPosition: position, currentPosition: position});
  },
