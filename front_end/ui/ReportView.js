...
WebInspector.ReportView =
  ...
  setSubtitle: function(subtitle) {
    ...
    if (!this._subtitleElement)
      this._subtitleElement =
          this._headerElement.createChild('div', 'report-subtitle');
  ...
  setURL: function(url) {
    ...
    if (!this._urlElement)
      this._urlElement =
          this._headerElement.createChild('div', 'report-url link');
  ...
  removeAllSection: function() { this._sectionList.removeChildren(); },
  ...
  __proto__: WebInspector.VBox.prototype
                                         ...
                                         * @param {string=} className
                                         */
                                        WebInspector.ReportView.Section =
  ...
  this._headerElement =
      this.element.createChild('div', 'report-section-header');
  this._titleElement =
      this._headerElement.createChild('div', 'report-section-title');
