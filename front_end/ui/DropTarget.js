 ...
 */
WebInspector.DropTarget =
    function(element, transferTypes, messageText, handleDrop) {
  ...
  _onDragOver: function(event) {
    ...
    var shadowRoot = WebInspector.createShadowRootWithCoreStyles(
        this._dragMaskElement, 'ui/dropTarget.css');
    shadowRoot.createChild('div', 'drop-target-message').textContent =
        this._messageText;
    this._dragMaskElement.addEventListener(
        'drop', this._onDrop.bind(this), true);
    this._dragMaskElement.addEventListener(
        'dragleave', this._onDragLeave.bind(this), true);
  },
