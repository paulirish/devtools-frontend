...
WebInspector.ActionRegistry =
  ...
  _registerActions: function() {
    self.runtime.extensions(WebInspector.ActionDelegate)
        .forEach(registerExtension, this);
  ...
  availableActions: function() {
    return this.applicableActions(
        this._actionsById.keysArray(), WebInspector.context);
  },
  ...
  applicableActions: function(actionIds, context) {
    ...
    return context.applicableExtensions(extensions)
        .valuesArray()
        .map(extensionToAction.bind(this));
    ...
    function extensionToAction(extension) {
      return /** @type {!WebInspector.Action} */ (
          this.action(extension.descriptor()['actionId']));
    }
  },
  ...
  /**
     ...
     * @return {?WebInspector.Action}
     */
  action: function(actionId) { return this._actionsById.get(actionId) || null; }
}
  ...
  /**
     * @return {string}
     */
  id: function() { return this._extension.descriptor()['actionId']; },
  ...
  execute: function() {
    ...
    function handleAction(actionDelegate) {
      ...
      var delegate =
          /** @type {!WebInspector.ActionDelegate} */ (actionDelegate);
  ...
  /**
     * @return {string}
     */
  icon: function() { return this._extension.descriptor()['iconClass'] || ''; },
  ...
  /**
     * @return {string}
     */
  tags: function() { return this._extension.descriptor()['tags'] || ''; },
