...
/**
 * @constructor
 * @param {(function(!WebInspector.Segment, !WebInspector.Segment):
 * ?WebInspector.Segment)=} mergeCallback
 */
WebInspector.SegmentedRange =
  ...
  append: function(newSegment) {
    ...
    var startIndex =
        this._segments.lowerBound(newSegment, (a, b) => a.begin - b.begin);
    ...
    while (endIndex < this._segments.length &&
           this._segments[endIndex].end <= newSegment.end)
      ++endIndex;
