...
WebInspector.Throttler =
  ...
  schedule: function(process, asSoonAsPossible) {
    ...
    var okToFire =
        window.performance.now() - this._lastCompleteTime > this._timeout;
  ...
  _innerSchedule: function(forceTimerUpdate) {
    ...
    this._processTimeout =
        this._setTimeout(this._onTimeout.bind(this), timeout);
  },

  /**
   *  @param {number} timeoutId
   */
  _clearTimeout: function(timeoutId) { clearTimeout(timeoutId); },
