 ...
 */
WebInspector.ServiceWorkerCacheView =
  ...
  _createDataGrid: function() {
    ...
    var dataGrid = new WebInspector.DataGrid(
        columns, undefined, this._deleteButtonClicked.bind(this),
  ...
  _deleteButtonClicked: function(node) {
    this._model.deleteCacheEntry(
        this._cache, node.data['request'], node.remove.bind(node));
  },
  ...
  _updateData: function(force) {
    ...
    if (!force && this._lastPageSize === pageSize &&
    ...
    this._model.loadCacheData(
        this._cache, skipCount, pageSize,
        this._updateDataCallback.bind(this, skipCount));
  },
  ...
  /**
     ...
     */
  syncToolbarItems: function() { return [this._refreshButton]; },
