(function() {
  ...
  diff_match_patch.prototype.diff_compute_ = function(a, b, c, d) {
    ...
    if (!b)
      return [[-1, a]];
    var e = a.length > b.length ? a : b, f = a.length > b.length ? b : a,
        g = e.indexOf(f);
    return -1 != g ?
        ...
        (f = e[0], a = e[1], g = e[2], b = e[3], e = e[4],
         f = this.diff_main(f, g, c, d), c = this.diff_main(a, b, c, d),
         f.concat([[0, e]], c)) :
        c && 100 < a.length && 100 < b.length ? this.diff_lineMode_(a, b, d) :
  ...
  diff_match_patch.prototype.diff_bisect_ = function(a, b, c) {
    for (var d = a.length, e = b.length, f = Math.ceil((d + e) / 2), g = f,
             h = 2 * f, j = Array(h), i = Array(h), k = 0;
         k < h; k++)
      j[k] = -1, i[k] = -1;
    j[g + 1] = 0;
    i[g + 1] = 0;
    for (var k = d - e, q = 0 != k % 2, r = 0, t = 0, p = 0, w = 0, v = 0;
         v < f && !((new Date).getTime() > c); v++) {
  ...
  diff_match_patch.prototype.diff_halfMatch_ = function(a, b) {
    function c(a, b, c) {
      for (var d = a.substring(c, c + Math.floor(a.length / 4)), e = -1, g = '',
               h, j, n, l;
           - 1 != (e = b.indexOf(d, e + 1));) {
        ...
        g.length < s + m && (g = b.substring(e - s, e) + b.substring(e, e + m),
                             h = a.substring(0, c - s), j = a.substring(c + m),
                             n = b.substring(0, e - s), l = b.substring(e + m))
      }
    ...
    var f = this, g = c(d, e, Math.ceil(d.length / 4)),
        d = c(d, e, Math.ceil(d.length / 2)), h;
    if (!g && !d)
      return null;
    h = d ? g ? g[4].length > d[4].length ? g : d : d : g;
    var j;
    a.length > b.length ? (g = h[0], d = h[1], e = h[2], j = h[3]) :
    ...
    for (var b = !1, c = [], d = 0, e = null, f = 0, g = 0, h = 0, j = 0, i = 0;
      ...
      0 == a[f][0] ?
          ...
          (1 == a[f][0] ? j += a[f][1].length : i += a[f][1].length, e &&
               ...
               (a.splice(c[d - 1], 0, [-1, e]), a[c[d - 1] + 1][0] = 1, d--,
                d--, f = 0 < d ? c[d - 1] : -1, i = j = h = g = 0, e = null,
                b = !0)),
          f++;
          ...
          if (d >= b.length / 2 || d >= c.length / 2)
            a.splice(f, 0, [0, c.substring(0, d)]),
                a[f - 1][1] = b.substring(0, b.length - d),
                      a[f + 1][1] = c.substring(d), f++
        } else if (e >= b.length / 2 || e >= c.length / 2)
          a.splice(f, 0, [0, b.substring(0, e)]),
              a[f - 1][0] = 1, a[f - 1][1] = c.substring(0, c.length - e),
                    a[f + 1][0] = -1, a[f + 1][1] = b.substring(e), f++;
        f++
      }
      f++
    }
  ...
  diff_match_patch.prototype.diff_cleanupSemanticLossless = function(a) {
    function b(a, b) {
      ...
      return i || j ?
          5 :
          c || d ? 4 : e && !g && h ? 3 : g || h ? 2 : e || f ? 1 : 0
    }
    for (var c = 1; c < a.length - 1;) {
      if (0 == a[c - 1][0] && 0 == a[c + 1][0]) {
        var d = a[c - 1][1], e = a[c][1], f = a[c + 1][1],
            g = this.diff_commonSuffix(d, e);
        if (g)
          var h = e.substring(e.length - g), d = d.substring(0, d.length - g),
              e = h + e.substring(0, e.length - g), f = h + f;
        for (var g = d, h = e, j = f, i = b(d, e) + b(e, f);
             e.charAt(0) === f.charAt(0);) {
          var d = d + e.charAt(0), e = e.substring(1) + f.charAt(0),
              f = f.substring(1), k = b(d, e) + b(e, f);
          k >= i && (i = k, g = d, h = e, j = f)
        }
        a[c - 1][1] != g &&
            (g ? a[c - 1][1] = g : (a.splice(c - 1, 1), c--), a[c][1] = h,
  ...
  diff_match_patch.prototype.diff_cleanupEfficiency = function(a) {
    for (var b = !1, c = [], d = 0, e = null, f = 0, g = !1, h = !1, j = !1,
             i = !1;
         f < a.length;) {
      if (0 == a[f][0])
      ...
      0 == a[b - 1][0] && 0 == a[b + 1][0] &&
          (a[b][1].substring(a[b][1].length - a[b - 1][1].length) ==
               ...
               (a[b][1] = a[b - 1][1] +
                ...
                a[b + 1][1] = a[b - 1][1] + a[b + 1][1], a.splice(b - 1, 1),
                c = !0) :
  ...
  diff_match_patch.prototype.diff_prettyHtml = function(a) {
    for (var b = [], c = /&/g, d = /</g, e = />/g, f = /\n/g, g = 0;
         g < a.length; g++) {
      var h = a[g][0], j = a[g][1], j = j.replace(c, '&amp;')
                                            .replace(d, '&lt;')
                                            .replace(e, '&gt;')
                                            .replace(f, '&para;<br>');
      switch (h) {
  ...
  diff_match_patch.prototype.diff_fromDelta = function(a, b) {
    for (var c = [], d = 0, e = 0, f = b.split(/\t/g), g = 0; g < f.length;
         g++) {
    ...
    if (e != a.length)
      throw Error(
          'Delta length (' + e + ') does not equal source text length (' +
          a.length + ').');
    return c
  };
  diff_match_patch.prototype.match_main = function(a, b, c) {
    ...
    return a == b ?
        0 :
        a.length ?
        a.substring(c, c + b.length) == b ? c : this.match_bitap_(a, b, c) :
        -1
  };
  diff_match_patch.prototype.match_bitap_ = function(a, b, c) {
    ...
    var e = this.match_alphabet_(b), f = this, g = this.Match_Threshold,
        h = a.indexOf(b, c);
    -1 != h && (g = Math.min(d(0, h), g), h = a.lastIndexOf(b, c + b.length),
                -1 != h && (g = Math.min(d(0, h), g)));
    for (var j = 1 << b.length - 1, h = -1, i, k, q = b.length + a.length, r,
             t = 0;
         t < b.length; t++) {
      i = 0;
      for (k = q; i < k;)
  ...
  diff_match_patch.prototype.patch_make = function(a, b, c) {
    ...
    if ('string' == typeof a && 'string' == typeof b && 'undefined' == typeof c)
      d = a, b = this.diff_main(d, b, !0), 2 < b.length &&
        ...
        a && 'object' == typeof a && 'undefined' == typeof b &&
        'undefined' == typeof c)
      b = a, d = this.diff_text1(b);
    else if (
        'string' == typeof a && b && 'object' == typeof b &&
        'undefined' == typeof c)
      d = a;
    else if (
        'string' == typeof a && 'string' == typeof b && c &&
        'object' == typeof c)
      d = a, b = c;
    else
      ...
      switch (i) {
        ...
        case 0:
          k.length <= 2 * this.Patch_Margin && e && b.length != j + 1 ?
              (a.diffs[e++] = b[j], a.length1 += k.length,
               a.length2 += k.length) :
              k.length >= 2 * this.Patch_Margin && e &&
                  (this.patch_addContext_(a, h), c.push(a),
                   a = new diff_match_patch.patch_obj, e = 0, h = d, f = g)
      }
      1 !== i && (f += k.length);
      -1 !== i && (g += k.length)
    }
    ...
    for (var d = 0, e = [], f = 0; f < a.length; f++) {
      ...
      if (h.length > this.Match_MaxBits) {
        if (j = this.match_main(b, h.substring(0, this.Match_MaxBits), g),
            -1 != j && (i = this.match_main(
                            b, h.substring(h.length - this.Match_MaxBits),
      ...
      if (-1 == j)
        e[f] = !1, d -= a[f].length2 - a[f].length1;
          ...
          e[f] = !0, d = j - g,
          g = -1 == i ? b.substring(j, j + h.length) :
                        b.substring(j, i + this.Match_MaxBits),
          h == g)
        b = b.substring(0, j) + this.diff_text2(a[f].diffs) +
            b.substring(j + h.length);
      else if (
          g = this.diff_main(h, g, !1), h.length > this.Match_MaxBits &&
        ...
        for (var h = 0, k, i = 0; i < a[f].diffs.length; i++) {
          ...
          1 === q[0] ? b = b.substring(0, j + k) + q[1] + b.substring(j + k) :
                       -1 === q[0] &&
                  (b = b.substring(0, j + k) +
  ...
  diff_match_patch.prototype.patch_addPadding = function(a) {
    ...
    if (0 == e.length || 0 != e[0][0])
      e.unshift([0, c]), d.start1 -= b, d.start2 -= b, d.length1 += b,
          d.length2 += b;
    ...
    0 == e.length || 0 != e[e.length - 1][0] ?
        ...
        b > e[e.length - 1][1].length &&
            (f = b - e[e.length - 1][1].length,
             e[e.length - 1][1] += c.substring(0, f), d.length1 += f,
             d.length2 += f);
    return c
  };
    ...
    for (var b = this.Match_MaxBits, c = 0; c < a.length; c++)
      if (!(a[c].length1 <= b)) {
        ...
        for (var e = d.start1, f = d.start2, g = ''; 0 !== d.diffs.length;) {
          ...
          for (; 0 !== d.diffs.length && h.length1 < b - this.Patch_Margin;) {
            ...
            1 === g ?
                (h.length2 += i.length, f += i.length,
                 h.diffs.push(d.diffs.shift()), j = !1) :
                -1 === g && 1 == h.diffs.length && 0 == h.diffs[0][0] &&
                        i.length > 2 * b ?
                (h.length1 += i.length, e += i.length, j = !1,
                 h.diffs.push([g, i]), d.diffs.shift()) :
                (i = i.substring(0, b - h.length1 - this.Patch_Margin),
                 h.length1 += i.length, e += i.length,
                 0 === g ? (h.length2 += i.length, f += i.length) : j = !1,
                 h.diffs.push([g, i]), i == d.diffs[0][1] ?
                     d.diffs.shift() :
          ...
          '' !== i &&
              (h.length1 += i.length, h.length2 += i.length,
  ...
  diff_match_patch.patch_obj.prototype.toString = function() {
    ...
    a = 0 === this.length1 ?
        this.start1 + ',0' :
        1 == this.length1 ? this.start1 + 1 :
                            this.start1 + 1 + ',' + this.length1;
    b = 0 === this.length2 ?
        this.start2 + ',0' :
        1 == this.length2 ? this.start2 + 1 :
