...
WebInspector.DeviceOrientation =
  ...
  /**
     * @return {string}
     */
  toSetting: function() { return JSON.stringify(this); },

  apply: function() {
    for (var target of WebInspector.targetManager.targets(
             WebInspector.Target.Capability.Browser))
      target.deviceOrientationAgent().setDeviceOrientationOverride(
 ...
 */
  ...
  if (value) {
    ...
    return new WebInspector.DeviceOrientation(
        jsonObject.alpha, jsonObject.beta, jsonObject.gamma);
  }
