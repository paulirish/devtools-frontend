 ...
 * @constructor
 */
WebInspector.DeviceModeWrapper =
  ...
  this._toggleDeviceModeAction =
      WebInspector.actionRegistry.action('emulation.toggle-device-mode');
  this._showDeviceModeSetting =
      WebInspector.settings.createSetting('emulation.showDeviceMode', false);
...
WebInspector.DeviceModeWrapper
  ...
  __proto__: WebInspector.VBox.prototype
                  ...
                  */
                 WebInspector.DeviceModeWrapper.ActionDelegate =
    function() {}
  ...
  handleAction: function(context, actionId) {
    if (WebInspector.DeviceModeView._wrapperInstance) {
      ...
      if (actionId === 'emulation.capture-screenshot')
        return WebInspector.DeviceModeView._wrapperInstance
            ._captureScreenshot();
    }
    return false;
  }
