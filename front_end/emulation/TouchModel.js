 ...
 */
WebInspector.MultitargetTouchModel =
    function() {
  ...
  WebInspector.targetManager.observeTargets(
    ...
    WebInspector.MultitargetTouchModel._symbol =
        Symbol('MultitargetTouchModel.symbol');
...
WebInspector.MultitargetTouchModel
  ...
  _applyToTarget: function(target) {
    ...
    var previous = target[symbol] ||
        {enabled: false, configuration: 'mobile', scriptId: ''};
    ...
    target.emulationAgent().setTouchEmulationEnabled(
        current.enabled, current.configuration);
  },
...
WebInspector.MultitargetTouchModel.instance = function() {
  if (!WebInspector.MultitargetTouchModel._instance)
    WebInspector.MultitargetTouchModel._instance =
        new WebInspector.MultitargetTouchModel();
