 ...
 */
WebInspector.Target =
    function(targetManager, name, capabilitiesMask, connection, parentTarget) {
  ...
  connection.addEventListener(
      InspectorBackendClass.Connection.Events.Disconnected, this._onDisconnect,
      this);
...
WebInspector.Target.prototype = {
  ...
  /**
     ...
     */
  targetManager: function() { return this._targetManager; },
  ...
  /**
     ...
     */
  connection: function() { return this._connection; },
  ...
  /**
     ...
     */
  parentTarget: function() { return this._parentTarget; },
  ...
  _dispose: function() {
    this._targetManager.dispatchEventToListeners(
        WebInspector.TargetManager.Events.TargetDisposed, this);
  ...
  /**
     * @return {boolean}
     */
  isDetached: function() { return this._connection.isClosed(); },
  ...
  /**
     ...
     */
  models: function() { return this._modelByConstructor.valuesArray(); },

  /**
     * @return {string}
     */
  inspectedURL: function() { return this._inspectedURL; },
  ...
  setInspectedURL: function(inspectedURL) {
    ...
    this._targetManager.dispatchEventToListeners(
        WebInspector.TargetManager.Events.InspectedURLChanged, this);
  },
  ...
  __proto__: WebInspector.Object.prototype
                                        ...
                                        * @param {!WebInspector.Target} target
                                        */
                                       WebInspector.SDKModel =
        function(modelClass, target) {
  WebInspector.SDKObject.call(this, target);
  target._modelByConstructor.set(modelClass, this);
  WebInspector.targetManager.addEventListener(
      WebInspector.TargetManager.Events.TargetDisposed, this._targetDisposed,
      this);
}
  ...
  /**
     * @return {!Promise}
     */
  suspendModel: function() { return Promise.resolve(); },

  /**
     * @return {!Promise}
     */
  resumeModel: function() { return Promise.resolve(); },
