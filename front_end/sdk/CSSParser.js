...
WebInspector.CSSParser =
  ...
  parsePromise: function(text) {
     ...
     */
    function promiseConstructor(succ, fail) { this.parse(text, succ); }
  },
  ...
  /**
     ...
     */
  rules: function() { return this._rules; },
  ...
  _unlock: function() { delete this._parsingStyleSheet; },
  ...
  _innerParse: function(text) {
    ...
    WebInspector.formatterWorkerPool.runChunkedTask(
        'parseCSS', params, this._onRuleChunk.bind(this));
  },
  ...
  __proto__: WebInspector.Object.prototype,
                                    ...
                                    * !Array.<!WebInspector.CSSParser.Rule>}}
                                    */
...
/**
 * @typedef {{startLine: number, startColumn: number, endLine: number,
 * endColumn: number}}
 */
