...
WebInspector.CSSStyleSheetHeader =
  ...
  if (payload.ownerNode)
    this.ownerNode =
        new WebInspector.DeferredDOMNode(cssModel.target(), payload.ownerNode);
  ...
  originalContentProvider: function() {
    if (!this._originalContentProvider) {
      var lazyContent =
          this._cssModel.originalStyleSheetText.bind(this._cssModel, this);
  ...
  resourceURL: function() {
    return this.isViaInspector() ? this._viaInspectorResourceURL() :
                                   this.sourceURL;
  },
  ...
  _viaInspectorResourceURL: function() {
    var resourceTreeModel =
        WebInspector.ResourceTreeModel.fromTarget(this.target());
  ...
  columnNumberInSource: function(
      lineNumberInStyleSheet, columnNumberInStyleSheet) {
    return (lineNumberInStyleSheet ? 0 : this.startColumn) +
  ...
  requestContent: function() {
    return /** @type {!Promise<?string>} */ (
        this._cssModel.getStyleSheetText(this.id));
  },
  ...
  isViaInspector: function() { return this.origin === 'inspector'; }
                      ...
                      */
                     WebInspector.CSSStyleSheetHeader.OriginalContentProvider =
        function(header) {
  this._header = header;
}
