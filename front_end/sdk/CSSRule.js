...
WebInspector.CSSValue =
  ...
  rebase: function(edit) {
    ...
    this.range = this.range.rebaseAfterTextEdit(edit.oldRange, edit.newRange);
                                      ...
                                      /**
                                       * @constructor
                                       * @param {!WebInspector.CSSModel}
                                       * cssModel
                                       * @param {{style: !CSSAgent.CSSStyle,
                                       * styleSheetId: (string|undefined),
                                       * origin: !CSSAgent.StyleSheetOrigin}}
                                       * payload
                                       */
                                      WebInspector.CSSRule =
        function(cssModel, payload) {
  ...
  this.style = new WebInspector.CSSStyleDeclaration(
      this._cssModel, this, payload.style,
      WebInspector.CSSStyleDeclaration.Type.Regular);
}
  ...
  resourceURL: function() {
    ...
    var styleSheetHeader =
        this._cssModel.styleSheetHeaderForId(this.styleSheetId);
 ...
 */
            WebInspector.CSSStyleRule.createDummyRule =
                function(cssModel, selectorText) {
  var dummyPayload = {
    selectorList: {
  ...
  return new WebInspector.CSSStyleRule(
      cssModel, /** @type {!CSSAgent.CSSRule} */ (dummyPayload));
}
  ...
  selectorRange: function() {
    ...
    return new WebInspector.TextRange(
        firstRange.startLine, firstRange.startColumn, lastRange.endLine,
        lastRange.endColumn);
  },
  ...
  rebase: function(edit) {
    ...
    if (this.selectorRange().equal(edit.oldRange)) {
      this._reinitializeSelectors(
          /** @type {!CSSAgent.SelectorList} */ (edit.payload));
    } else {
  ...
  keyframes: function() { return this._keyframes; }
                                      ...
                                      * @extends {WebInspector.CSSRule}
                                      * @param {!WebInspector.CSSModel} cssModel
                                      * @param {!CSSAgent.CSSKeyframeRule}
                                      * payload
                                      */
                                     WebInspector.CSSKeyframeRule =
                        function(cssModel, payload) {
  WebInspector.CSSRule.call(this, cssModel, payload);
