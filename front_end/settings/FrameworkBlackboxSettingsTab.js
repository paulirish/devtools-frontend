 ...
 */
WebInspector.FrameworkBlackboxSettingsTab =
    function() {
  ...
  var addPatternButton = createTextButton(
      WebInspector.UIString('Add pattern...'),
  ...
  _addButtonClicked: function() {
    this._list.addNewItem(
        this._setting.getAsArray().length, {pattern: '', disabled: false});
  },
  ...
  _createEditor: function() {
    ...
    titles.createChild(
        'div', 'blackbox-separator blackbox-separator-invisible');
    titles.createChild('div', 'blackbox-behavior').textContent =
        WebInspector.UIString('Behavior');
    ...
    fields.createChild('div', 'blackbox-pattern')
        .appendChild(editor.createInput(
            'pattern', 'text', '/framework\\.js$',
            patternValidator.bind(this)));
    fields.createChild(
        'div', 'blackbox-separator blackbox-separator-invisible');
