 ...
 */
  ...
  if (!WebInspector.ARIAMetadata._instance)
    WebInspector.ARIAMetadata._instance = new WebInspector.ARIAMetadata(
        WebInspector.ARIAMetadata._config || null);
  ...
  _initialize: function(config) {
    ...
    for (var name in attributes) {
      ...
      this._attributes.set(
          name, new WebInspector.ARIAMetadata.Attribute(attributeConfig));
    }
