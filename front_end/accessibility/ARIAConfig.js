WebInspector.ARIAMetadata._config = {
  ...
  'roles': {
    ...
    'alertdialog':
        {'nameFrom': ['author'], 'superclasses': ['alert', 'dialog']},
    ...
    'list': {
      'mustContain': ['group', 'listitem', 'listitem'],
      'nameFrom': ['author'],
      'superclasses': ['region']
    },
    'listbox': {
    ...
    'option': {
      ...
      'superclasses': ['input'],
      'supportedAttributes':
          ['aria-checked', 'aria-posinset', 'aria-selected', 'aria-setsize']
    },
    'presentation': {'superclasses': ['structure']},
    'progressbar': {'nameFrom': ['author'], 'superclasses': ['range']},
    'radio': {
      'nameFrom': ['contents', 'author'],
      'superclasses': ['checkbox', 'option']
    },
    'radiogroup': {
      'mustContain': ['radio'],
      'nameFrom': ['author'],
    ...
    'select': {
      'abstract': true,
      'nameFrom': ['author'],
      'superclasses': ['composite', 'group', 'input']
    },
    'separator': {
      'nameFrom': ['author'],
      'superclasses': ['structure'],
