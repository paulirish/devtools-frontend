...
WebInspector.AccessibilityStrings
  ...
  'relatedElement':
      {name: 'Related element', description: 'Value from related element.'}
}

                     WebInspector.AccessibilityStrings.AXNativeSourceTypes = {
  'figcaption':
      {name: 'From caption', description: 'Value from figcaption element.'},
  ...
  'tablecaption':
      {name: 'From caption', description: 'Value from table caption.'},
  'other': {
