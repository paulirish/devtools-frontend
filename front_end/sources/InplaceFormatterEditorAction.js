 ...
 */
WebInspector.InplaceFormatterEditorAction =
    function() {}
  ...
  _updateButton: function(uiSourceCode) {
    this._button.element.classList.toggle(
        'hidden', !this._isFormattable(uiSourceCode));
  },
  ...
  button: function(sourcesView) {
    ...
    this._button = new WebInspector.ToolbarButton(
        WebInspector.UIString('Format'), 'format-toolbar-item');
  ...
  _formatSourceInPlace: function() {
    ...
    function innerCallback(formattedContent, formatterMapping) {
      ...
      if (sourceFrame) {
        ...
        start = formatterMapping.originalToFormatted(
