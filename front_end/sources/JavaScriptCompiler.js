 ...
 */
WebInspector.JavaScriptCompiler =
...
WebInspector.JavaScriptCompiler.prototype = {
  scheduleCompile: function() {
    ...
    this._timeout = setTimeout(
        this._compile.bind(this), WebInspector.JavaScriptCompiler.CompileDelay);
  },
  ...
  _compile: function() {
    ...
    runtimeModel.compileScript(
        code, '', false, currentExecutionContext.id,
    ...
    function compileCallback(target, scriptId, exceptionDetails) {
      ...
      this._sourceFrame.uiSourceCode().addLineMessage(
          WebInspector.UISourceCode.Message.Level.Error, text,
