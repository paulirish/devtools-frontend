...
WebInspector.OpenResourceDialog =
    function(sourcesView, defaultScores, history) {
  WebInspector.FilteredUISourceCodeListDelegate.call(
      this, defaultScores, history);
  ...
  /**
     ...
     * @return {boolean}
     */
  shouldShowMatchingItems: function(query) { return !query.startsWith(':'); },
  ...
  /**
     ...
     * @return {boolean}
     */
  renderAsTwoRows: function() { return true; },
  ...
  __proto__: WebInspector.FilteredUISourceCodeListDelegate.prototype
                      ...
                      * @param {!WebInspector.SourcesView} sourcesView
                      * @param {string} query
                      * @param {!Map.<!WebInspector.UISourceCode, number>}
                      * defaultScores
                      * @param {!Array<string>} history
                      */
                     WebInspector.OpenResourceDialog.show =
        function(sourcesView, query, defaultScores, history) {
  WebInspector.OpenResourceDialog._instanceForTest =
      new WebInspector.OpenResourceDialog(sourcesView, defaultScores, history);
  var filteredItemSelectionDialog = new WebInspector.FilteredListWidget(
      WebInspector.OpenResourceDialog._instanceForTest);
     ...
     */
                ...
                WebInspector.SelectUISourceCodeForProjectTypesDialog.show =
                  ...
                  var filteredItemSelectionDialog =
                      new WebInspector.FilteredListWidget(
                          new WebInspector
