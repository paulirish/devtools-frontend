 ...
 */
WebInspector.AdvancedSearchView =
    function() {
  ...
  this._searchPanelElement =
      this.contentElement.createChild('div', 'search-drawer-header');
  ...
  this._search.placeholder = WebInspector.UIString(
      'Search all sources (use "file:" to filter by path)\u200e');
  ...
  this._ignoreCaseLabel =
      createCheckboxLabel(WebInspector.UIString('Ignore case'));
  ...
  this._regexLabel =
      createCheckboxLabel(WebInspector.UIString('Regular expression'));
  ...
  this._searchToolbarElement =
      this.contentElement.createChild('div', 'search-toolbar-summary');
  ...
  _buildSearchConfig: function() {
    return new WebInspector.SearchConfig(
        this._search.value, this._ignoreCaseCheckbox.checked,
  ...
  _onSearchResult: function(searchId, searchResult) {
    ...
    if (!this._searchResultsPane)
      this._searchResultsPane =
          this._searchScope.createSearchResultsPane(this._searchConfig);
    this._resetResults();
  ...
  _innerStartSearch: function(searchConfig) {
    ...
    this._searchScope.performSearch(
        searchConfig, this._progressIndicator,
  ...
  _searchStarted: function(progressIndicator) {
    ...
    if (!this._searchingView)
      this._searchingView = new WebInspector.EmptyWidget(
          WebInspector.UIString('Searching\u2026'));
  ...
  _nothingFound: function() {
    ...
    if (!this._notFoundView)
      this._notFoundView = new WebInspector.EmptyWidget(
  ...
  _load: function() {
    var searchConfig = WebInspector.SearchConfig.fromPlainObject(
        this._advancedSearchConfig.get());
  ...
  addSearchResult: function(searchResult) {}
                              ...
                              */
                             WebInspector.AdvancedSearchView.ActionDelegate =
                function() {}
  ...
  _showSearch: function() {
    ...
    WebInspector.AdvancedSearchView.openSearch(queryCandidate);
                                  ...
                                  */
                                 WebInspector.FileBasedSearchResult =
                    function(uiSourceCode, searchMatches) {
