...
(function(fit) {
  ...
  /**
   * This module provides methods for fitting a terminal's size to a parent
   * container.
   *
  ...
  exports.proposeGeometry = function(term) {
    var parentElementStyle =
        ...
        contentBuffer = subjectRow.innerHTML, characterHeight, rows,
        characterWidth, cols, geometry;
  ...
  Xterm.prototype.fit = function() { return exports.fit(this); };
